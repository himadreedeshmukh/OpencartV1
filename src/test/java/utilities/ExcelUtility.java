...
public  String getCellData(String sheetName,int rownum,int colnum) throws IOException
{
	...
	try 
	{
		//data=cell.toString(); //Extract the cell data in String format
		DataFormatter formatter = new DataFormatter();
		data=formatter.formatCellValue(cell); //Returns the formated value of cell as string 
	}
    catch(Exception e)
	{
    	data ="";
...
{//Reading
	...
	{
		workbook = new XSSFWorkbook(); //8888888888
